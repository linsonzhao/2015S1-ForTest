...
class processor {
	...
	// Create a constructor method
	public processor() {
//		 face_cascade = new CascadeClassifier(FaceDetection_opencv.class.getResource("haarcascade_frontalface_alt.xml").getPath());
		face_cascade = new CascadeClassifier("C:/temp/haarcascade_frontalface_alt.xml");
...
public class FaceDetection_opencv {
